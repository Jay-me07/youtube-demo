        ...
        <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
            ...
            <div className="subscribed-list">
                ...
                <div className="side-links">
                    <img src={jack} alt="" /><p>Israel Mbonyi</p>
                </div>
                <div className="side-links">
                    <img src={simon} alt="" /><p>J Hus</p>
                </div>
                <div className="side-links">
                    <img src={tom} alt="" /><p>Burna Boy</p>
                </div>
                <div className="side-links">
                    <img src={megan} alt="" /><p>Dave</p>
                </div>
                <div className="side-links">
                    <img src={cameron} alt="" /><p>Wakadinali</p>
                </div>
            </div>
        </div>
    </div>
